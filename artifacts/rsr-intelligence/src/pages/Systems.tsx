  ...
  return (
    <Layout>
      <div className="flex flex-col gap-10">
        ...
        <div className="border border-zinc-900 bg-zinc-950 px-5 py-3 flex flex-wrap items-center gap-6 font-mono text-[9px] tracking-[0.3em]">
        ...
        <div className="grid xl:grid-cols-4 gap-8 items-start">
          ...
          <div className="xl:col-span-3">
            <div className="font-mono text-[9px] tracking-[0.4em] text-zinc-700 mb-5">DEPLOYED MODULES</div>
          ...
          <div className="xl:col-span-1 space-y-8 sticky top-6">
            ...
            <div>
              ...
              <div className="border border-zinc-900 bg-black divide-y divide-zinc-900">
                {diagnostics.map(stat => (
                  <div key={stat.label} className="flex justify-between items-center px-4 py-3 font-mono text-[10px] tracking-widest">
            ...
            <div className="border border-zinc-900 p-4">
              <div className="font-mono text-[9px] tracking-[0.3em] text-zinc-600 mb-3">ARCHITECTURE</div>
