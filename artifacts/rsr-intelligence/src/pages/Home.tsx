export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.035] mix-blend-overlay bg-[linear-gradient(transparent_95%,rgba(16,185,129,0.4)_100%)] bg-[length:100%_4px]" />
      ...
      <div className="mx-auto max-w-7xl px-6 py-6 relative z-10">
        ...
        <header className="flex items-center justify-between border-b border-emerald-500/10 pb-5">
          ...
          <nav className="flex gap-2 font-mono text-[10px] tracking-[0.35em]">
            {["SYSTEMS", "FILES", "DOSSIERS", "WORLD"].map((item) => (
              <button key={item} className="px-3 py-2 border border-zinc-800 bg-black text-zinc-500 hover:text-emerald-300 hover:border-emerald-500/40 transition cursor-pointer">
                {item}
              </button>
            ))}
          </nav>
        ...
        <section className="py-16">
          ...
          <div className="mt-8 flex gap-4">
            <button className="border border-emerald-500/40 px-5 py-2 text-emerald-300 font-mono text-[10px] tracking-[0.3em] hover:bg-emerald-500/10 transition cursor-pointer">
              ENTER SYSTEM
            </button>
            <button className="border border-zinc-800 px-5 py-2 text-zinc-400 font-mono text-[10px] tracking-[0.3em] hover:border-zinc-600 transition cursor-pointer">
              VIEW FILES
            </button>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            {systems.map((system) => (
              <div key={system.name} className="group border border-zinc-900 bg-black/80 p-5 hover:border-emerald-500/40 transition-all duration-300 relative overflow-hidden hover:shadow-[0_0_20px_rgba(16,185,129,0.15)] cursor-pointer">

                <div className="absolute inset-0 opacity-0 group-hover:opacity-10 bg-[linear-gradient(transparent_95%,rgba(16,185,129,0.4)_100%)] bg-[length:100%_6px]" />
                ...
                <div className="absolute bottom-0 left-0 w-full h-[2px] bg-emerald-500/0 group-hover:bg-emerald-500/40 transition" />
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="border-t border-zinc-900 pt-6">
          ...
          <div className="flex gap-3">
            <button className="border border-emerald-500/40 px-4 py-2 text-emerald-300 font-mono text-[10px] tracking-[0.3em] hover:bg-emerald-500/10 transition cursor-pointer">
              REQUEST ACCESS
            </button>
            <button className="border border-zinc-800 px-4 py-2 text-zinc-400 font-mono text-[10px] tracking-[0.3em] hover:border-zinc-600 transition cursor-pointer">
              LOGIN
            </button>
          </div>
        </section>
